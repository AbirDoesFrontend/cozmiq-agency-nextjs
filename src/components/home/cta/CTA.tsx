...
const CTA = () => {
    return (<section className="bg-white dark:bg-[#01010A] py-16 lg:py-[140px] text-center">
        <div className="relative py-14 md:py-16 lg:py-[100px] rounded-[20px] cta wrapper">
            ...
            <div className="mb-4">
                <BadgeSecondary text={"Get In Touch"}/>
            </div>
            ...
            <div
                className="flex justify-start items-start gap-2 mt-[48px] border border-[#FFFFFF1A] rounded-[100px] get-in-touch-btn">
                <Image
                    src={CtaPersonImage}
                    alt="avatar"
