...
import WhiteIcon1 from "../../../../public/img/white-icon1.png";
import WhiteIcon2 from "../../../../public/img/white-icon2.png";
import WhiteIcon3 from "../../../../public/img/white-icon3.png";
import WhiteIcon4 from "../../../../public/img/white-icon4.png";
import WhiteIcon5 from "../../../../public/img/white-icon5.png";
import WhiteIcon6 from "../../../../public/img/white-icon6.png";
          ...
          <div className="gap-6 lg:gap-8 grid grid-cols-1 md:grid-cols-2">
            {ServicesData.map((service, index) => (
              ...
              >
                ...
                <h3 className="mb-4 text-[#07080B] dark:text-white">
                  {service.title}
                </h3>
                <p className="text-[#07080B] dark:text-white">
                  {service.description}
