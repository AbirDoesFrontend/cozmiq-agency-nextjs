            ...
            <div className="relative mx-auto py-4 wrapper">
                ...
                <div className="relative">
                    ...
                    <div className="gap-6 grid lg:grid-cols-3 sm:px-16 md:px-36 lg:px-0">
                        <div
                            className="group relative hover:bg-[#FFFFFF1A]  border border-[#FFFFFF1A] rounded-[20px] hover:scale-105 active:scale-95 transition-all hover:-translate-y-2 duration-300 cursor-pointer button-hover">
                            <div className="p-4">
                                <div
                                    className="bg-[#ffffff11] hover:bg-[#ffffff1f] active:bg-[#ffffff1f] mb-8 p-4 rounded-[20px]">
                                    <div className="mb-5.5">
                                        <button
                                            className="bg-gray-800/50 backdrop-blur mb-4 px-3 py-2 rounded-[100px] font-medium text-sm">
                                            Basic
                                        </button>
                                        <div id="basicPrice" className="flex items-baseline mb-5 font-bold text-4xl">
                                    ...
                                    <button
                                        className="bg-gray-800/50 hover:bg-gray-800 backdrop-blur px-8 py-3.5 rounded-[100px] w-full font-semibold text-gray-300 hover:text-[#0939d6] text-lg duration-200 b-none cursor-pointer">
                                        Book a Free Call
                                    </button>
                                </div>
                            ...
                            <div className="p-4">
                                <div
                                    ...
                                    <div className="mb-5.5">
                                        ...
                                        <div className="flex items-baseline mb-5 font-bold text-4xl" id="proPrice">
                                    ...
                                    <button
                                        className="bg-gray-800/50 hover:bg-[linear-gradient(135deg,#3273ff_0%,#0939d6_100%)] active:bg-[linear-gradient(135deg,#3273ff_0%,#0939d6_100%)] backdrop-blur px-8 py-3.5 rounded-[100px] w-full font-semibold text-gray-300 hover:text-white active:text-white text-lg duration-200 b-none cursor-pointer">
                                        Book A Free Call
                                    </button>
                                </div>
                      ...
                      Weekly updates and monthly reports
                        ...
                        {/* premium */}
                        <div
                            className="group relative  border border-[#FFFFFF1A] rounded-[20px] hover:scale-105 active:scale-95 transition-all hover:-translate-y-2 duration-300 cursor-pointer button-hover">
                            <div className="p-4">
                                <div className="bg-[#ffffff11] mb-8 p-4 rounded-[20px]">
                                    <div className="mb-5.5">
                                        ...
                                        <div className="flex items-baseline mb-5 font-bold text-4xl" id="premiumPrice">
                                    ...
                                    <button
                                        className="bg-gray-800/50 hover:bg-gray-800 backdrop-blur px-8 py-3.5 rounded-[100px] w-full font-semibold text-gray-300 hover:text-[#0939d6] text-lg duration-200 cursor-pointer">
                                        Book a Free Call
                                    </button>
                                </div>
