...
const WhyChooseUs = () => {
    return (<section className="bg-[#f9f9f9] dark:bg-[#01010A] py-16 lg:py-[140px]">
                ...
                <div className="flex lg:flex-row flex-col items-start gap-12">
                    ...
                    <div className="lg:w-1/2">
                        <div className="space-y-4 lg:space-y-3 xl:space-y-4">
                            <div
                                className="bg-white dark:bg-[#FFFFFF0D] hover:shadow-xl p-8 lg:p-4 xl:p-8 border dark:border-none rounded-xl transition-all hover:-translate-y-1 duration-300 transform">
